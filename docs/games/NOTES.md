...
| 4 | `escape` | ✅ **σε PR** — 3 δωμάτια, ένα τη Δευτέρα από 21/9· παίχτηκε όλο το Δωμάτιο 1 σε 375×812 |
| 5 | `rhythm` | ✅ **σε PR** — 5 τραγούδια × 3 δυσκολίες, ρολόι Web Audio, calibration· παίχτηκε σε 375×812 |
| 6 | `machine` | ✅ **σε PR** — δική μας ντετερμινιστική φυσική, 6 εργαλεία, 15 επίπεδα, κωδικός με checksum· παίχτηκε σε 375×812 |
