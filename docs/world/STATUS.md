...
| 7 | Έλεγχος pins (εκκλησίες, αγορά 2 στενά) | Επιβεβαιώθηκε και μετρήθηκε (Bolhão 62 m, Carmo ζευγάρι νόμιμο 15 m, Στάδιο 127 m). World: resolver + 35 πόρτες + 5 `findIt`. **Explorer live: 180 pins χωρίς κανέναν έλεγχο** |
