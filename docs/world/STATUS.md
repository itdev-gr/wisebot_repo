...
Νίκαια, Λυών), 64 overlays (Λισαβόνα fr/de/es/it), 485 σελίδες World, 431 μέρη.
...
- **Νέος φύλακας «μπροστινή πόρτα».** Το `world.test.ts` ελέγχει τώρα τα `countries.<lang>.json`.
  ...
  #112, #124, #132, #135). Στη λίστα `KNOWN_ABSENT_CARDS` μένουν μόνο οι 8 κάρτες Νίκαιας/Λυών
  (#142). Το Πόρτο είναι η μόνη πόλη χωρίς overlays (τα γαλλικά τρέχουν).
