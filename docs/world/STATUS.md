...
Σάββατο 19/9 μεσημέρι: main `983b2ad`, CI πράσινο.
...
- **Νέος φύλακας «μπροστινή πόρτα».** Το `world.test.ts` ελέγχει τώρα τα `countries.<lang>.json`.
  ...
  #112, #124, #132, #135, #149). Η λίστα `KNOWN_ABSENT_CARDS` είναι κενή (19/9): κάθε πόλη του
  main έχει κάρτα στις έξι γλώσσες, και οι 18 πόλεις με overlays είναι πλήρεις σε 4 γλώσσες.
  Οι 10 νεότερες (Λευκωσία → Λυών) είναι μόνο el/en και πέφτουν τίμια σε αγγλικά.
