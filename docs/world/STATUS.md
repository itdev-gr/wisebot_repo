...
τα PR ενσωμάτωσης της νύχτας (#137, #139) και το πρωινό #142 (Νίκαια, Λυών): 28 πόλεις (μπήκαν
Λευκωσία, Ντουμπρόβνικ, Μαδρίτη, Βενετία, Κοπεγχάγη, Μπριζ, Κρακοβία, Φλωρεντία, Σεβίλλη,
Νίκαια, Λυών), 68 overlays (Λισαβόνα και Πόρτο fr/de/es/it), 485 σελίδες World, 431 μέρη.
Σάββατο 19/9 βράδυ, με το #159 (Αττάλεια, Εδιμβούργο): 30 πόλεις, 460 μέρη, 66 μουσεία,
516 σελίδες World, 484 κλιπ αφήγησης. Επόμενες πόλεις από το content session: Νέα Υόρκη,
Ουάσινγκτον, Σαν Φρανσίσκο.
...
- **Νέος φύλακας «μπροστινή πόρτα».** Το `world.test.ts` ελέγχει τώρα τα `countries.<lang>.json`.
  Βρήκε 60 κάρτες πόλεων χωρίς μετάφραση· και οι 60 μεταφράστηκαν την ίδια νύχτα (#110,
  #112, #124, #132, #135, #149). Στη λίστα `KNOWN_ABSENT_CARDS` μένουν οι 8 κάρτες Αττάλειας/
  Εδιμβούργου (#159). Οι 18 πόλεις με overlays είναι πλήρεις σε 4 γλώσσες· οι 12 νεότερες
  (Λευκωσία → Εδιμβούργο) είναι μόνο el/en και πέφτουν τίμια σε αγγλικά.
...
- **Αφήγηση (19/9):** 484 κλιπ με συγχρονισμό λέξεων. Αθήνα, Παρίσι, Ρώμη, Λονδίνο, Ηράκλειο,
  Ρόδος, Δελφοί πλήρεις. Τρία κλιπ έχουν ήχο χωρίς συγχρονισμό (ταίριασμα κάτω από 80%):
  `delphi-tholos-en` 51%, `rhodes-kallithea-el` 79%, `rome-piazza-navona-el` 76%. Τα
  Westminster el/en και Cité argonaute el/en ξαναηχογραφήθηκαν γιατί άλλαξε το κείμενό τους
  (π.χ. «1245» αντί «πριν 750 χρόνια»). Επόμενες πόλεις για αφήγηση: Θεσσαλονίκη, Άμστερνταμ,
  Βαρκελώνη, Κων/πολη… (~1250 λεπτά ομιλίας συνολικά, quota ~100 κλιπ/μέρα).
- **Λονδίνο ακόμη όχι.** 18/9 βράδυ: 9 από 17 με OSM· 19/9 μεσημέρι: 5 από 17 (429/504). Κανένα
  run δεν κρατήθηκε. Το Overpass απαντά μεμονωμένα queries, όχι batches — το ίδιο είδε το content
  session στη Λισαβόνα. Βαρκελώνη, Πράγα, Σεβίλλη και οι 71 της λίστας C περιμένουν το ίδιο.
