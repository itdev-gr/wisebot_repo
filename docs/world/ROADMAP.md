...
| Συντεταγμένες | 5 πόλεις έχουν αρχείο: Αθήνα, Θεσσαλονίκη, Ηράκλειο, Ρόδος, Πόρτο |
...
| Γλώσσες | 6 δηλωμένες· ελληνικά και αγγλικά μέσα στις πόλεις, οι άλλες τέσσερις ως overlays στο `data/world/i18n/` |
