...
const T = {
  el: {
    ...
    stars: 'αστέρια', comingSoon: 'Έρχονται: Ρώμη, Παρίσι, Βαρκελώνη, Πόρτο…', attribution: 'Χάρτης: OpenStreetMap',
  },
  en: {
    ...
    stars: 'stars', comingSoon: 'Coming: Rome, Paris, Barcelona, Porto…', attribution: 'Map: OpenStreetMap',
  },
};
