...
const COMMUNITY_CHARACTERS = [
  { id: 'bunny', name: 'Bunny', creator: 'Μαρία, 8', src: '/images/bunny.jpg' },
  { id: 'pilot', name: 'Pilot', creator: 'Γιάννης, 11', src: '/images/pilot.jpg' },
  { id: 'drake', name: 'Drake', creator: 'Νίκος, 10', src: '/images/drake.jpg' },
  { id: 'dolphi', name: 'Dolphi', creator: 'Ελένη, 9', src: '/images/dolphi.jpg' },
  { id: 'panda', name: 'Panda', creator: 'Αλέξης, 7', src: '/images/panda.jpg' },
  { id: 'fly', name: 'Fly', creator: 'Σοφία, 12', src: '/images/fly.jpg' },
  { id: 'golde', name: 'Golde', creator: 'Δημήτρης, 10', src: '/images/golde.jpg' },
  { id: 'sharki', name: 'Sharki', creator: 'Κατερίνα, 11', src: '/images/sharki.jpg' },
  { id: 'donkey', name: 'Donkey', creator: 'Παναγιώτης, 8', src: '/images/donkey.jpg' },
  { id: 'ratti', name: 'Ratti', creator: 'Χριστίνα, 9', src: '/images/ratti.jpg' },
  { id: 'montzi', name: 'Montzi', creator: 'Στέφανος, 12', src: '/images/montzi.jpg' },
  { id: 'octapus', name: 'Octapus', creator: 'Αναστασία, 10', src: '/images/octapus.jpg' },
  { id: 'tauru', name: 'Tauru', creator: 'Μιχάλης, 11', src: '/images/tauru.jpg' },
  { id: 'piguin', name: 'Piguin', creator: 'Ειρήνη, 7', src: '/images/piguin.jpg' },
  { id: 'skoti', name: 'Skoti', creator: 'Βασίλης, 13', src: '/images/skoti.jpg' },
  { id: 'hamel', name: 'Hamel', creator: 'Ελευθερία, 9', src: '/images/hamel.jpg' },
  { id: 'buty', name: 'Buty', creator: 'Γεωργία, 8', src: '/images/buty.jpg' },
  { id: 'kukku', name: 'Ku Ku', creator: 'Θανάσης, 10', src: '/images/ku ku.jpg' },
];
