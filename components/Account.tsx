...
export default function Account({ lang, onClaimBonus, lastClaimDate }: AccountProps) {
  ...
  const text = {
    el: {
      ...
      giftDesc: 'Πέρνα κάθε μέρα και πάρε 30 XP. Τα credits τα κερδίζεις με ολόκληρα βιβλία — ή από το Store.',
      claim: 'ΠΑΡΕ 30 XP',
      comeBack: 'ΕΛΑ ΑΥΡΙΟ ΓΙΑ ΑΛΛΑ',
      claimed: 'ΤΑ ΠΗΡΕΣ!',
      inviteTitle: 'Προσκάλεσε Φίλους',
      inviteDesc: 'Στείλε τον κωδικό σου! Όταν ο φίλος σου πάρει τα πρώτα του credits, εσύ παίρνεις +10⚡.',
    ...
    en: {
      ...
      giftDesc: 'Come by every day for 30 XP. Credits come from whole books — or the Store.',
      claim: 'CLAIM 30 XP',
      comeBack: 'COME BACK TOMORROW',
      claimed: 'CLAIMED!',
      inviteTitle: 'Invite Friends',
      inviteDesc: 'Share your code! When your friend gets their first credits, you get +10⚡.',
      inviteCopy: 'COPY',
      inviteCopied: 'COPIED!',
      inviteShare: 'SHARE',
