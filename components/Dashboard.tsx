  ...
  return (
    <div className="pb-32 relative z-10 px-4 max-w-7xl mx-auto animate-in fade-in duration-700 space-y-10">
      ...
      {/* 🌍 WISEBOT WORLD — the family feature: real cities, museums, a passport.
          ...
          but there is one door on the dashboard, and this is it. */}
      <button
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <h3 className="text-xl md:text-2xl font-[1000] text-white uppercase italic tracking-tighter leading-none mt-0.5">WiseBot World</h3>
          <p className="text-white/55 text-xs md:text-sm font-bold mt-1 truncate">{lang === 'el' ? 'Διαβατήριο με σφραγίδες, αληθινές πόλεις, μουσεία με αινίγματα.' : 'A passport with stamps, real cities, museums with riddles.'}</p>
        </div>
