...
const TEXT = {
  el: {
    ...
    successRegister: 'Στείλαμε email στον γονέα σου! Πρέπει να πατήσει το link για να ενεργοποιηθεί ο λογαριασμός.',
  ...
  en: {
    ...
    successRegister: 'We sent an email to your parent! They need to click the link to activate your account.',
...
const AuthScreen: React.FC<AuthScreenProps> = ({ lang }) => {
  ...
  const { user, loading: authLoading, emailVerified, signUp, signIn } = useAuth();
  const t = TEXT[lang];
