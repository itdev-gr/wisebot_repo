...
const CONTENT = {
  'ai-paidia': {
    ...
    description: {
      el: 'Ανακάλυψε τον κόσμο του AI για παιδιά! Φτιάξε τραγούδια, εικόνες, video, 3D μοντέλα. Μάθε ιστορίες 90 σπουδαίων ανθρώπων. Το 1ο Ελληνικό εκπαιδευτικό AI για παιδιά 6-13.',
      en: 'Discover the world of AI for kids! Create songs, images, videos, 3D models. Learn stories of 90 great people. The 1st Greek educational AI for kids 6-13.',
    },
    path: '/ai-paidia',
  ...
  'ekpaideutiko-ai': {
    ...
    description: {
      el: 'Εκπαιδευτικό AI που μαθαίνει στα παιδιά 6-13 ετών. Ιστορίες 90 σπουδαίων ανθρώπων, ebooks, quiz, επιχειρηματικότητα. Αναγνωρισμένο από εκπαιδευτικούς.',
      en: 'Educational AI that teaches kids aged 6-13. Stories of 90 great people, ebooks, quizzes, entrepreneurship. Recognized by educators.',
    },
    ...
    sections: [
      {
        ...
        items: [
          { icon: '🧠', h3: { el: 'Ιστορίες 90 Σπουδαίων Ανθρώπων', en: 'Stories of 90 Great People' }, text: { el: 'Αϊνστάιν, Tesla, Curie, Da Vinci, Mandela — διαδραστικές ιστορίες με ήχο, εικόνες και quiz.', en: 'Einstein, Tesla, Curie, Da Vinci, Mandela — interactive stories with audio, images and quizzes.' }, link: '/academy' },
          { icon: '📖', h3: { el: '26 Εκπαιδευτικά Ebooks', en: '26 Educational Ebooks' }, text: { el: 'Αρχαία Ελλάδα, Διάστημα, Ζώα, Τεχνολογία — κάθε βιβλίο έχει AI αφήγηση και quiz.', en: 'Ancient Greece, Space, Animals, Technology — every book has AI narration and quiz.' }, link: '/ebooks' },
