...
export const UI_TEXT = {
  ...
  en: {
    menu: { home: 'Home', school: 'School', dashboard: 'Dashboard', academy: 'Academy', factory: 'Hero Factory', factory3d: '3D Factory', market: 'Hero Market', music: 'Music Studio', business: 'My Business', wiseFriends: 'Wise & Friends', quiz: 'Quiz Zone', ebooks: 'Ebooks', game: 'Wise Games', cinema: 'Cinema', world: 'The World', store: 'Credit Store', parent: 'Parent Dashboard', admin: 'Admin Panel', account: 'Account', logout: 'Logout' },
