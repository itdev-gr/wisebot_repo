...
ROUTES.push({
  path: '/istoria-mas',
  title: 'Η Ιστορία μας — Η Οικογένεια πίσω από το WiseBot | WiseBot Academy',
  description: 'Το WiseBot φτιάχτηκε από μια οικογένεια με τρία παιδιά. Οι φωνές στα βιβλία είναι οι δικές τους, οι ιστορίες από τη δική τους καθημερινότητα. Όλα τα παιδιά έχουν μεγάλα όνειρα — είμαστε εδώ για να μην τα ξεχάσουν ποτέ.',
  ogTitle: 'Η Ιστορία μας — Η Οικογένεια πίσω από το WiseBot',
  noscript: `
    <h1>Η Ιστορία μας — Η Οικογένεια πίσω από το WiseBot</h1>
    <p>Το WiseBot δεν γεννήθηκε σε γραφείο. Γεννήθηκε σε ένα σπίτι με τρία παιδιά. Οι φωνές που ακούγονται στα 34 βιβλία είναι τα ίδια τα παιδιά της οικογένειας, και οι ιστορίες είναι από όσα έζησαν στο σχολείο και στην καθημερινότητά τους.</p>
    <p>Ο πατέρας της οικογένειας, με χρόνια εμπειρίας στις επιχειρήσεις, μαθαίνει στα παιδιά — και μέσα από το WiseBot σε όλα τα παιδιά — να βάζουν μεγάλους στόχους, να σηκώνονται μετά από κάθε δυσκολία, να διαλέγουν σωστά φίλους και συνήθειες, και να κάνουν τον χρόνο στην οθόνη δημιουργικό: από θεατές, δημιουργοί.</p>
    <p>Όλα τα παιδιά του κόσμου έχουν μεγάλα όνειρα. Όσο μεγαλώνουμε τα ξεχνάμε. Είμαστε εδώ για να τα θυμηθούν οι μεγάλοι — και να μην τα ξεχάσουν ποτέ οι μικροί. Με αγάπη, η οικογένεια WiseBot.</p>
    <p><a href="${BASE_URL}/school">🎓 Σχολείο</a> | <a href="${BASE_URL}/ebooks">📚 Ebooks</a> | <a href="${BASE_URL}/">🏠 Αρχική</a></p>
  `,
});
