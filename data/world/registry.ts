...
const LOADERS: Record<CityId, () => Promise<CityModule>> = {
  ...
  'edinburgh': () => import('./cities/edinburgh'),
  'florence': () => import('./cities/florence'),
  ...
  'lyon': () => import('./cities/lyon'),
  'madrid': () => import('./cities/madrid'),
  'nice': () => import('./cities/nice'),
  ...
  'seville': () => import('./cities/seville'),
  'thessaloniki': () => import('./cities/thessaloniki'),
  'venice': () => import('./cities/venice'),
...
const I18N: Record<string, () => Promise<{ default: unknown }>> = {
  ...
  'budapest.de': () => import('./i18n/budapest.de.json'),
  'budapest.es': () => import('./i18n/budapest.es.json'),
  'budapest.fr': () => import('./i18n/budapest.fr.json'),
  'budapest.it': () => import('./i18n/budapest.it.json'),
  ...
  'lisbon.de': () => import('./i18n/lisbon.de.json'),
  'lisbon.es': () => import('./i18n/lisbon.es.json'),
  'lisbon.fr': () => import('./i18n/lisbon.fr.json'),
  'lisbon.it': () => import('./i18n/lisbon.it.json'),
  ...
  'porto.de': () => import('./i18n/porto.de.json'),
  'porto.es': () => import('./i18n/porto.es.json'),
  'porto.fr': () => import('./i18n/porto.fr.json'),
  'porto.it': () => import('./i18n/porto.it.json'),
