...
// ============================================================
// BOOK 29: Ο ΚΑΛΥΤΕΡΟΣ ΠΩΛΗΤΗΣ ΤΟΥ ΚΟΣΜΟΥ / THE GREATEST SALESMAN IN THE WORLD
// Hero: WiseBot (η κουκουβάγια)
// Inspired by the ideas of «The Greatest Salesman in the World» by Og Mandino
// Original children's story set in the WiseBot universe — ideas only, retold
// ============================================================

export const BOOK_29: Book[] = [
  {
    id: 29,
    ...
    meaning: {
      ...
      en: "The greatest salesman in the world is not the one who shouts the loudest. It is the one who helps the most honestly — and persists until he succeeds."
    },
    xp: 100,
    parentMessage: {
    ...
    pages: [
      {
        title: { el: "Το Παγκάκι με τις Λεμονάδες", en: "The Lemonade Stand" },
        image: "/images/ta-3-paidia.webp",
        imageCaption: { el: "Μια κανάτα γεμάτη. Ένα ταμείο άδειο.", en: "A full jug. An empty cash box." },
        text: {
          el: `Το Σάββατο ξημέρωσε λαμπερό. Η Αλεξάνδρα και ο Φίλιππος είχαν σηκωθεί από τις επτά το πρωί. Έστησαν ένα μικρό τραπέζι στην πλατεία: μια κανάτα παγωμένη λεμονάδα, χάρτινα ποτήρια, και δίπλα τα χειροποίητα βραχιόλια που έφτιαχναν όλη την εβδομάδα.

«Μέχρι το μεσημέρι θα τα έχουμε πουλήσει όλα», είπε ο Φίλιππος και έτριψε τα χέρια του.

Πέρασε μία ώρα. Μετά δύο. Ο κόσμος περνούσε βιαστικά. Κάποιοι χαμογελούσαν ευγενικά. Κανείς δεν σταματούσε.

«Λεμονάδα! Φρέσκια λεμονάδα!» φώναζε ο Φίλιππος, όλο και πιο δυνατά. Και όσο πιο δυνατά φώναζε, τόσο πιο γρήγορα περπατούσε ο κόσμος.

Η Αλεξάνδρα μετρούσε από μέσα της. Μηδέν λεμονάδες. Μηδέν βραχιόλια. Μηδέν ευρώ.

Το μεσημέρι ο ήλιος έκαιγε και η κανάτα ήταν ακόμα γεμάτη. Ο Φίλιππος κλότσησε ένα πετραδάκι. «Δεν ξέρουμε να πουλάμε», μουρμούρισε. «Ή μήπως... αυτά που φτιάχνουμε δεν αξίζουν;»

Η Αλεξάνδρα δεν απάντησε. Αυτή η σκέψη πονούσε πιο πολύ από την αποτυχία.

Και τότε, πάνω στο κλαδί της μουριάς, κάτι γυάλισε. Δύο μωβ μάτια τους παρακολουθούσαν ώρα. Η WiseBot πέταξε αθόρυβα και προσγειώθηκε δίπλα στην κανάτα.

«Ξέρετε ποιο είναι το πιο περίεργο;» είπε ήρεμα. «Σήμερα δεν προσπαθήσατε να βοηθήσετε ούτε έναν άνθρωπο. Μόνο να πουλήσετε προσπαθούσατε.»
...
The children looked at her, confused. But... was that not the same thing?`
      ...
      {
        title: { el: "Οι Αρχαίοι Πάπυροι", en: "The Ancient Scrolls" },
        image: "/images/wisebot.jpg",
        imageCaption: { el: "Έξι πάπυροι. Έξι μυστικά.", en: "Six scrolls. Six secrets." },
        text: {
          el: `Η WiseBot χτύπησε απαλά τα φτερά της. Τα μάτια της φωτίστηκαν, όπως πάντα όταν είχε μια ιστορία να πει.

«Πριν από πολλά, πολλά χρόνια», άρχισε, «σε μια χώρα με καμήλες και καραβάνια, ζούσε ένα αγόρι που δεν είχε τίποτα. Πουλούσε νερό στους ταξιδιώτες της ερήμου. Όλοι του έλεγαν όχι. Και όμως, μεγαλώνοντας, έγινε ο καλύτερος πωλητής του κόσμου.»

«Πώς;» ρώτησε ο Φίλιππος.

«Ένας σοφός γέρος έμπορος του εμπιστεύτηκε κάτι αρχαίους παπύρους. Ο καθένας έκρυβε μέσα του μια συνήθεια. Ακούστε τους καλά.»

Η φωνή της έγινε σχεδόν ψίθυρος.

«Ο πρώτος πάπυρος έλεγε: σήμερα ξεκινάω από την αρχή — το χθες δεν με κρατάει πίσω. Ο δεύτερος: θα επιμένω μέχρι να τα καταφέρω. Ο τρίτος: αγαπώ τους ανθρώπους — πουλάω μόνο όταν βοηθάω. Ο τέταρτος: οι συνήθειές μου με φτιάχνουν — ό,τι κάνω κάθε μέρα, αυτό γίνομαι. Ο πέμπτος: γελάω με τις δυσκολίες, γιατί καμία δεν κρατάει για πάντα. Και ο έκτος: κάθε όχι με φέρνει ένα βήμα πιο κοντά στο ναι.»

Η Αλεξάνδρα σκεφτόταν δυνατά. «Δηλαδή το να πουλάς... δεν είναι να παίρνεις λεφτά;»

«Το να πουλάς», είπε η WiseBot, «είναι να λύνεις τίμια το πρόβλημα κάποιου. Τα χρήματα είναι απλώς το ευχαριστώ που ακολουθεί.»
...
Τι είδαν; Ανθρώπους που έτρεχαν γύρω γύρω και τελείωναν ιδρωμένοι και διψασμένοι. Γιαγιάδες που κουβαλούσαν βαριές σακούλες κάτω από τον καυτό ήλιο. Παιδιά που έπαιζαν μπάλα στο γηπεδάκι μέχρι να κοκκινίσουν.

«Εκεί!» είπε η Αλεξάνδρα. «Δίπλα στο γηπεδάκι. Εκεί διψάνε πραγματικά.»

Μετέφεραν το τραπέζι. Έβαλαν πάγο και φύλλα δυόσμου στην κανάτα. Και άλλαξαν και κάτι ακόμα: τον τρόπο.

Ένας κύριος σταμάτησε να πάρει ανάσα από το τρέξιμο. Η Αλεξάνδρα δεν φώναξε. Πλησίασε και ρώτησε: «Τρέξατε πολύ σήμερα; Θέλετε μια γουλιά παγωμένη, να δείτε αν σας αρέσει;»

Ο κύριος δοκίμασε. Χαμογέλασε. «Δύο ποτήρια, παρακαλώ.»

Το πρώτο ναι! Μετά ήρθε άλλο ένα. Και ένα όχι. Και άλλο ένα ναι. Ο Φίλιππος βοήθησε μια γιαγιά να ακουμπήσει τις σακούλες της και της έφερε ποτήρι χωρίς να πληρώσει. «Για τη δροσιά», είπε ντροπαλά.

Και τότε, ο ουρανός σκοτείνιασε. Μπουμπουνητό. Η βροχή άδειασε την πλατεία σε δύο λεπτά. Τα βραχιόλια βράχηκαν, η κανάτα μισή, τα κέρματα μετρημένα στα δάχτυλα.

«Πάλι αποτύχαμε;» ρώτησε ο Φίλιππος, κοιτάζοντας τα σύννεφα.`,
          en: `On Sunday morning, the children did not set up the table right away. First they sat on a bench and observed the square. Like detectives.
...
«Did we fail again?» asked Philippos, staring at the clouds.`
      ...
      {
        title: { el: "Το Παιχνίδι των Όχι", en: "The Game of No" },
        image: "/images/filippos.webp",
        imageCaption: { el: "Κάθε όχι, ένα σκαλί. Κάθε πρωί, μια νέα αρχή.", en: "Every no, a step. Every morning, a fresh start." },
        text: {
          el: `Το επόμενο πρωί, η Αλεξάνδρα ξύπνησε και είπε δυνατά τις λέξεις του πρώτου παπύρου: «Σήμερα ξεκινάω από την αρχή.» Η χθεσινή βροχή δεν είχε δικαίωμα να αποφασίζει για το σήμερα.

Έφτιαξαν νέες συνήθειες, όπως έλεγε ο τέταρτος πάπυρος. Κάθε πρωί: φρέσκος πάγος, δοκιμή γεύσης, καθαρό τραπέζι, χαμόγελο. Ο Φίλιππος κρατούσε και ένα μικρό σημειωματάριο. Μέσα έγραφε ό,τι έλεγαν οι πελάτες.

«Η κυρία Ρένα είπε πολύ γλυκιά η λεμονάδα.» Την επόμενη μέρα, λιγότερη ζάχαρη. «Ο μικρός Νίκος ήθελε βραχιόλι με το όνομά του.» Την επόμενη μέρα, βραχιόλια με χάντρες-γράμματα.

Και μετά ήρθε η μεγάλη ιδέα του Φίλιππου: το παιχνίδι των όχι.

«Ο έκτος πάπυρος λέει ότι κάθε όχι μας φέρνει πιο κοντά στο ναι», είπε. «Άρα τα όχι δεν είναι εχθροί. Είναι σκαλιά!» Ζωγράφισε μια σκάλα σε ένα χαρτόνι. Κάθε φορά που κάποιος έλεγε όχι, χρωμάτιζαν ένα σκαλί. Στο πέμπτο σκαλί, σχεδόν πάντα, ερχόταν ένα ναι.

Το όχι έπαψε να πονάει. Έγινε παιχνίδι. Μια μέρα, ένας κύριος αρνήθηκε τόσο απότομα που τα παιδιά κοιτάχτηκαν και... έβαλαν τα γέλια. Πέμπτος πάπυρος: γελάω με τις δυσκολίες.
...
But their big goal was elsewhere: the neighbourhood fair, on Saturday.`
      ...
      {
        title: { el: "Ο Καλύτερος Πωλητής", en: "The Greatest Salesman" },
        image: "/images/paidia-wisebot-2.webp",
        imageCaption: { el: "Δεν κέρδισαν απλώς χρήματα. Κέρδισαν ανθρώπους.", en: "They did not just earn money. They earned people." },
        text: {
          el: `Το Σάββατο, η πλατεία γέμισε κόσμο, μουσικές και μυρωδιές. Τα παιδιά έστησαν το τραπέζι τους νωρίς — με πάγο, δυόσμο, τη σκάλα των όχι και το σημειωματάριο.

Αλλά δεν περίμεναν πίσω από το τραπέζι. Κυκλοφορούσαν. Βοηθούσαν. Η Αλεξάνδρα έδειξε σε μια μαμά πού ήταν η σκιά για το καροτσάκι. Ο Φίλιππος κουβάλησε καφάσια για τον κύριο με τα καρπούζια. Και όποιος φαινόταν διψασμένος, άκουγε την ίδια απλή ερώτηση: «Θέλετε μια γουλιά παγωμένη, να δείτε αν σας αρέσει;»

Η κανάτα άδειασε. Τη γέμισαν. Άδειασε ξανά. Τα βραχιόλια με τα ονόματα έφευγαν ένα ένα.

Κάποια στιγμή, ένα αγοράκι στάθηκε μπροστά στο τραπέζι. Κοιτούσε τη λεμονάδα. Οι τσέπες του ήταν άδειες. Η Αλεξάνδρα του έδωσε ένα γεμάτο ποτήρι. «Κερασμένο», είπε. «Τρίτος πάπυρος», ψιθύρισε ο Φίλιππος χαμογελώντας.

Το απόγευμα, η μαμά του αγοριού ήρθε να τους βρει. «Είδα τι κάνατε», είπε. «Την άλλη Κυριακή έχουμε γενέθλια. Θέλω είκοσι λεμονάδες και δέκα βραχιόλια με ονόματα. Μπορείτε;»

Τα παιδιά κοιτάχτηκαν με γουρλωμένα μάτια. «Μπορούμε!»

Όταν άδειασε η πλατεία, η WiseBot προσγειώθηκε στο τραπέζι. «Καταλάβατε τώρα το μυστικό των παπύρων;»

Η Αλεξάνδρα κοίταξε το άδειο ταμείο που ξεχείλιζε. «Ο καλύτερος πωλητής του κόσμου», είπε αργά, «είναι ο καλύτερος βοηθός του κόσμου.»
