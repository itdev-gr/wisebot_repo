...
export const CITY: ExploreCity = {
  ...
  zoom: 14,
  intro: {
    el: 'Καλώς ήρθατε στο Πόρτο, εξερευνητές! Είμαι η WiseBot, η κουκουβάγια-οδηγός σας, κι εδώ ο ποταμός Δούρος (Douro) κυλάει ανάμεσα σε λόφους γεμάτους πολύχρωμα σπίτια. Θα περάσουμε γέφυρες από σίδερο, θα διαβάσουμε ιστορίες ζωγραφισμένες σε μπλε πλακάκια και θα δούμε τις παλιές βάρκες με τα βαρέλια να λικνίζονται στο νερό. Πιάστε το χέρι των γονιών σας: ξεκινάμε από ψηλά και κατεβαίνουμε σιγά σιγά ως το ποτάμι!',
