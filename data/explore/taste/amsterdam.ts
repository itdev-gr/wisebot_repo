...
export const TASTE: TasteItem[] = [
  {
    ...
    kidTip: { el: 'Το κόλπο των Ολλανδών: ακούμπησέ την πάνω στην κούπα με τη ζεστή σοκολάτα σου — ο ατμός λιώνει το σιρόπι. Στην αγορά ζήτα «een verse stroopwafel, alstublieft» (μία φρέσκια, παρακαλώ).', en: 'The Dutch trick: rest it on top of your mug of hot chocolate — the steam melts the syrup. At the market ask for “een verse stroopwafel, alstublieft” (a fresh one, please).' },
  ...
  },
  {
    ...
    funFact: { el: 'Ο μεγάλος ξάδερφός τους, η κροκέτα (kroket), πουλιέται «από τον τοίχο» (uit de muur): σε σνακ-μπαρ με σειρές από μικρά γυάλινα πορτάκια βάζεις κέρματα, ανοίγεις το πορτάκι και παίρνεις την καυτή κροκέτα.', en: 'Their big cousin, the kroket, is sold “from the wall” (uit de muur): at snack bars with rows of little glass doors you drop in coins, open a door and take out the hot kroket.' },
  ...
  },
  {
    ...
    kidTip: { el: 'Για τολμηρούς! Η εύκολη εκδοχή: ζήτα «in stukjes» (σε κομματάκια) με ένα σημαιάκι-οδοντογλυφίδα, ή μέσα σε μαλακό ψωμάκι (broodje haring). Το κρεμμύδι το βάζεις μόνο αν θες.', en: 'For brave tasters! The easy version: ask for it “in stukjes” (in pieces) with a little flag toothpick, or in a soft bun (broodje haring). Onions only if you want them.' },
    funFact: { el: 'Η σεζόν ανοίγει κάθε Ιούνιο με την «Ημέρα των Σημαιών» (Vlaggetjesdag) στο λιμάνι του Σχέβενινγκεν: το πρώτο βαρέλι της χρονιάς πουλιέται σε δημοπρασία για φιλανθρωπικό σκοπό, συνήθως για δεκάδες χιλιάδες ευρώ.', en: 'The season opens every June with “Flag Day” (Vlaggetjesdag) in Scheveningen harbour: the first barrel of the year is auctioned for charity, usually for tens of thousands of euros.' },
  ...
  },
  {
    ...
    what: { el: 'Μεγάλοι κίτρινοι τροχοί τυριού ντυμένοι με κερί, κίτρινο ή κόκκινο. Το νεαρό (jong) είναι μαλακό και βουτυράτο· το παλιό (oud) σκληρό, αλμυρό και τρίζει στα δόντια από μικρούς κρυστάλλους.', en: 'Big yellow wheels of cheese dressed in wax, yellow or red. Young (jong) is soft and buttery; old (oud) is hard, salty and crunches with tiny crystals.' },
  ...
  },
  {
    ...
    funFact: { el: 'Τα πιο παλιά καφενεία της πόλης λέγονται «καφετιά» (bruin café): οι ξύλινοι τοίχοι και τα ταβάνια τους σκούρυναν από τον καπνό και τα χρόνια, και κανείς δεν τα ξαναέβαψε.', en: 'The city’s oldest pubs are called “brown cafés” (bruin café): their wooden walls and ceilings turned dark from smoke and the years, and nobody ever repainted them.' },
