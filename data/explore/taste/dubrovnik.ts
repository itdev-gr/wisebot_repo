...
export const TASTE: TasteItem[] = [
  {
    ...
    kidTip: { el: 'Παραγγέλνεται από πριν — συχνά την προηγούμενη μέρα — και είναι για όλη την οικογένεια. Το κρέας είναι η ήπια εκδοχή, το χταπόδι για όσους θέλουν κάτι διαφορετικό. Όταν σηκώνουν την καμπάνα κάνε ένα βήμα πίσω — καίει! — και πες «hvala» (ευχαριστώ).', en: 'You order it ahead — often the day before — and it is for the whole family. Meat is the mild choice, octopus for those who want something different. When they lift the bell take a step back — it is scorching — then say “hvala” (thank you)!' },
    funFact: { el: 'Η λέξη «peka» σημαίνει και το φαγητό και το σιδερένιο καπάκι: η καμπάνα θάβεται στη χόβολη πάνω σε ένα πέτρινο τζάκι που λέγεται «komin» και μένει εκεί δύο με τρεις ώρες.', en: 'The word “peka” means both the dish and the iron lid: the bell is buried in embers on a stone hearth called a “komin” and stays there for two to three hours.' },
  ...
  },
  {
    ...
    name: { el: 'Μαύρο ριζότο (Crni rižot)', en: 'Black risotto (Crni rižot)' },
    ...
    kidTip: { el: 'Βάφει τα δόντια και τη γλώσσα μαύρα για λίγο — βγάλε μια φωτογραφία! Ξεκίνα με μια πιρουνιά από το πιάτο του γονιού και ζήτα ψωμί δίπλα.', en: 'It stains your teeth and tongue black for a while — take a photo! Start with one forkful from a parent’s plate and ask for bread on the side.' },
    funFact: { el: 'Το μελάνι είναι το «σύννεφο» που εκτοξεύει η σουπιά για να κρυφτεί από τους εχθρούς της. Το ίδιο πιάτο είναι διάσημο και στη Βενετία, στην απέναντι ακτή της Αδριατικής — λέγεται ότι από εκεί ήρθε η συνταγή στη Δαλματία.', en: 'The ink is the “cloud” a cuttlefish squirts to hide from its enemies. The same dish is famous in Venice, across the Adriatic — the story goes that the recipe came to Dalmatia from there.' },
  ...
  },
  {
    ...
    funFact: { el: 'Το όνομά της έρχεται από το «rozalin», ένα άρωμα από ροδοπέταλα που έβαζαν οι νοικοκυρές του Ντουμπρόβνικ στην κρέμα. Από παλιά είναι το γλυκό των γιορτών και των μεγάλων οικογενειακών τραπεζιών.', en: 'Its name comes from “rozalin”, a rose-petal flavouring that Dubrovnik cooks used to perfume the custard. It has long been the sweet of feast days and big family meals.' },
  ...
  },
  {
    ...
    name: { el: 'Ζαχαρωμένη φλούδα πορτοκαλιού (Arancini)', en: 'Candied orange peel (Arancini)' },
    what: { el: 'Λωρίδες από φλούδα πορτοκαλιού, βρασμένες σε σιρόπι και πασπαλισμένες με ζάχαρη. Μαστιχωτές, γλυκές και λίγο πικρούλες — καμία σχέση με τα σικελικά αραντσίνι, που είναι τηγανητά μπαλάκια από ρύζι!', en: 'Strips of orange peel boiled in syrup and rolled in sugar. Chewy, sweet and a little bitter — nothing to do with the Sicilian arancini, which are fried rice balls!' },
  ...
  },
  {
    ...
    name: { el: 'Παγωτό (Sladoled)', en: 'Ice cream (Sladoled)' },
    what: { el: 'Παγωτό σε χωνάκι, με πολλές γεύσεις στη βιτρίνα — από φράουλα και σοκολάτα μέχρι φιστίκι, καμιά φορά και σύκο. Το βράδυ όλη η πόλη κάνει βόλτα με ένα στο χέρι.', en: 'Ice cream in a cone, with lots of flavours in the window — from strawberry and chocolate to pistachio and sometimes fig. In the evening the whole town strolls with one in hand.' },
    kidTip: { el: 'Παράγγειλέ το εσύ: «jednu kuglu, molim» (μία μπάλα, παρακαλώ) — και «hvala» στο τέλος. Οι ουρές μεγαλώνουν μετά το ηλιοβασίλεμα, πήγαινε λίγο νωρίτερα.', en: 'Order it yourself: “jednu kuglu, molim” (one scoop, please) — and “hvala” at the end. The queues get long after sunset, so go a little earlier.' },
  ...
  },
  {
    ...
    what: { el: 'Μοσχάρι που σιγοβράζει ώρες σε μια γλυκόξινη σάλτσα με δαμάσκηνα και λαχανικά, μέχρι να λιώσει στο πιρούνι. Σερβίρεται με σπιτικά νιόκι (njoki) που ρουφούν τη σάλτσα.', en: 'Beef simmered for hours in a sweet-and-sour sauce with prunes and vegetables until it falls apart on the fork. Served with homemade gnocchi (njoki) that soak up the sauce.' },
    kidTip: { el: 'Η σάλτσα είναι γλυκούλα από τα δαμάσκηνα και τα νιόκι αρέσουν σε όλους — ζήτα ένα πιάτο για μοιρασιά και βούτα ψωμί στη σάλτσα.', en: 'The sauce is sweet from the prunes and the gnocchi are an easy win — ask for a plate to share and dip your bread in the sauce.' },
    ...
    where: { el: 'Σε παραδοσιακές ταβέρνες (konoba), συχνά ως πιάτο της Κυριακής — είναι πιάτο όλης της Δαλματίας, πιο διάσημο γύρω από το Σπλιτ.', en: 'In traditional taverns (konoba), often as the Sunday dish — it belongs to all of Dalmatia and is most famous around Split.' },
  },
  {
    id: 'plavac-mali', emoji: '🍷', kind: 'drink', brave: 1, adultsOnly: true,
    name: { el: 'Πλάβατς μάλι (Plavac mali)', en: 'Plavac mali' },
    what: { el: 'Το κόκκινο κρασί της νότιας Δαλματίας, από τις απότομες πλαγιές της χερσονήσου Πέλιεσατς κοντά στο Ντουμπρόβνικ — μόνο για τους γονείς.', en: 'The red wine of southern Dalmatia, from the steep slopes of the Pelješac peninsula near Dubrovnik — for the parents only.' },
    ...
    funFact: { el: 'Γύρω στο 2000 οι επιστήμονες έδειξαν με τεστ DNA ότι το Plavac mali είναι «παιδί» του Zinfandel — της διάσημης ποικιλίας της Καλιφόρνιας, που τελικά κατάγεται από τη Δαλματία (Crljenak kaštelanski).', en: 'Around 2000, DNA tests showed that Plavac mali is a “child” of Zinfandel — California’s famous grape, which turned out to come from Dalmatia (Crljenak kaštelanski).' },
