...
export const TASTE: TasteItem[] = [
  {
    ...
    funFact: { el: 'Το όνομα σημαίνει «Γαλλιδούλα»: ο δημιουργός της, τη δεκαετία του 1950, την εμπνεύστηκε από το γαλλικό croque-monsieur και την έκανε πολύ πιο πλούσια.', en: 'The name means “little French girl”: its creator in the 1950s was inspired by the French croque-monsieur and made it much richer.' },
  ...
  },
  {
    ...
    funFact: { el: 'Γεννήθηκε πριν από περισσότερα από 200 χρόνια στο Μοναστήρι των Ιερωνυμιτών, στη Λισαβόνα: λέγεται ότι οι μοναχοί κολλάριζαν τα ράσα τους με ασπράδια αυγού και με τους κρόκους που περίσσευαν έφτιαχναν γλυκά.', en: 'It was born more than 200 years ago in the Jerónimos Monastery in Lisbon: the story goes that the monks starched their robes with egg whites and made sweets with the leftover yolks.' },
  ...
  },
  {
    ...
    kidTip: { el: 'Ιδανικό πρώτο «τολμηρό» φαγητό: κανονικά δεν έχει κόκαλα και μοιάζει με πατατοκροκέτα.', en: 'A perfect first “brave” food: normally no bones, and it looks like a potato croquette.' },
    ...
    where: { el: 'Σε καφέ, μικρές ταβέρνες (tascas) και στους πάγκους των αγορών.', en: 'In cafés, small taverns (tascas) and at market counters.' },
  },
  {
    ...
    funFact: { el: 'Τη νύχτα του Αγίου Ιωάννη (23 Ιουνίου) όλο το Πόρτο ψήνει σαρδέλες στους δρόμους και οι άνθρωποι χτυπούν ο ένας τον άλλον απαλά στο κεφάλι με πλαστικά σφυράκια!', en: 'On St John’s night (23 June) the whole of Porto grills sardines in the street and people tap each other on the head with soft plastic hammers!' },
  ...
  },
  {
    ...
    funFact: { el: 'Ήρθε από τα χωριά του Μίνιο, στον βορρά της Πορτογαλίας, και είναι η σούπα των γάμων και των πανηγυριών — συχνά σερβίρεται αργά τη νύχτα, στο τέλος της γιορτής!', en: 'It came from the villages of the Minho, in the north of Portugal, and is the soup of weddings and festivals — often served late at night, at the end of the party!' },
  ...
  },
  {
    ...
    kidTip: { el: 'Στην παραλία το πουλάνε πλανόδιοι φωνάζοντας «Bolinha!» — άκου τη φωνή και πες το στους γονείς σου.', en: 'On the beach it is sold by walking vendors calling “Bolinha!” — listen for the call and tell your parents.' },
    funFact: { el: 'Το όνομα σημαίνει «μπάλα του Βερολίνου»: λέγεται ότι η συνταγή ήρθε με πρόσφυγες από τη Γερμανία στα χρόνια του Β΄ Παγκοσμίου Πολέμου, αλλά οι Πορτογάλοι άλλαξαν τη γέμιση από μαρμελάδα σε κρέμα αυγού.', en: 'The name means “Berlin ball”: the story goes the recipe arrived with refugees from Germany around the Second World War, but the Portuguese swapped the jam filling for egg custard.' },
  ...
  },
  {
    ...
    what: { el: 'Το πιο παραδοσιακό πιάτο της πόλης: ένα μαγειρευτό με φασόλια, λουκάνικο και… πατσά, δηλαδή εντόσθια. Έχει έντονη γεύση και το λατρεύουν οι ντόπιοι.', en: 'The city’s most traditional dish: a stew of beans, sausage and… tripe. Strong-tasting and beloved by the locals.' },
    ...
    where: { el: 'Σε παραδοσιακές ταβέρνες, συχνά ως πιάτο ημέρας.', en: 'In traditional taverns, often as the dish of the day.' },
  },
  {
    ...
    funFact: { el: 'Πολλά είδη του παλαιώνουν χρόνια σε ξύλινα βαρέλια· κάποια μπουκάλια είναι παλιότερα από τους παππούδες σας.', en: 'Many kinds age for years in wooden barrels; some bottles are older than your grandparents.' },
    where: { el: 'Στις κάβες της Βίλα Νόβα ντε Γκάια (Vila Nova de Gaia), στην άλλη όχθη του Δούρου.', en: 'In the cellars of Vila Nova de Gaia, on the other bank of the Douro.' },
  },
];
