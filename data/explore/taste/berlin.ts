...
export const TASTE: TasteItem[] = [
  {
    ...
    kidTip: { el: 'Ζήτα την «nicht scharf, bitte» (όχι καυτερή) και πάρε πατάτες δίπλα: «Eine Currywurst mit Pommes, bitte». Οι Βερολινέζοι θα σε ρωτήσουν «mit oder ohne Darm» — με ή χωρίς πέτσα· το «ohne» δαγκώνεται πιο εύκολα.', en: 'Ask for it “nicht scharf, bitte” (not spicy) and add chips: “Eine Currywurst mit Pommes, bitte”. Berliners will ask “mit oder ohne Darm” — with or without skin; “ohne” is easier to bite.' },
  ...
  },
  {
    ...
    kidTip: { el: 'Αν το αλάτι είναι πολύ, τίναξέ το με το δάχτυλο. Πες «Eine Brezel, bitte» στον φούρνο — και μάθε ότι εδώ το απλό ψωμάκι λέγεται «Schrippe», μια λέξη που τη λένε μόνο οι Βερολινέζοι!', en: 'If there is too much salt, flick it off with a finger. Say “Eine Brezel, bitte” at the bakery — and learn that here a plain bread roll is a “Schrippe”, a word only Berliners use!' },
    funFact: { el: 'Εδώ και 700 περίπου χρόνια το πρέτσελ είναι το σήμα της συντεχνίας των φουρνάρηδων: κοίτα πάνω από τις πόρτες των παλιών φούρνων και θα δεις ένα χρυσό πρέτσελ να κρέμεται.', en: 'For around 700 years the pretzel has been the sign of the bakers’ guild: look above the doors of old bakeries and you will spot a golden pretzel hanging there.' },
  ...
  },
  {
    ...
    funFact: { el: 'Το Βερολίνο λέει ότι το ντονέρ «σε πίτα, με σαλάτα» γεννήθηκε εδώ στις αρχές της δεκαετίας του 1970, από Τούρκους εργάτες που ήθελαν φαγητό για το χέρι — άλλες πόλεις όμως το διεκδικούν κι αυτές!', en: 'Berlin says the döner “in bread, with salad” was born here in the early 1970s, made by Turkish workers who wanted a meal to eat on the go — though other cities claim it too!' },
  ...
  },
  {
    ...
    kidTip: { el: 'Σε όλη τη Γερμανία το λένε «Berliner», αλλά στο Βερολίνο ζήτα «Einen Pfannkuchen, bitte» — αλλιώς ο φούρναρης θα χαμογελάσει. Δάγκωσέ το πάνω από το πιάτο: η μαρμελάδα πετάγεται!', en: 'The rest of Germany calls it a “Berliner”, but in Berlin ask for “Einen Pfannkuchen, bitte” — otherwise the baker will smile. Bite it over the plate: the jam squirts out!' },
    funFact: { el: 'Την παραμονή της Πρωτοχρονιάς οι Γερμανοί τρώνε Pfannkuchen τα μεσάνυχτα — και πολλοί φούρνοι φτιάχνουν ένα γεμιστό με… μουστάρδα, για να το βρει κάποιος άτυχος της παρέας!', en: 'On New Year’s Eve Germans eat Pfannkuchen at midnight — and many bakeries make one filled with… mustard, for one unlucky guest to find!' },
  ...
  },
  {
    ...
    what: { el: 'Ένα ολόκληρο κότσι χοιρινού, βρασμένο ώρες μέχρι το κρέας να γίνει τόσο μαλακό που πέφτει από το κόκαλο. Έρχεται με ξινολάχανο (Sauerkraut) και πουρέ από αρακά, σε πιάτο γίγα.', en: 'A whole pork knuckle, boiled for hours until the meat is so soft it slips off the bone. It comes with sauerkraut and pea purée, on a giant plate.' },
    kidTip: { el: 'Μόνο για τολμηρούς: το κρέας μέσα είναι απαλό, αλλά η πέτσα και το λίπος απ’ έξω είναι ζελεδένια. Δοκίμασε μια μπουκιά από το πιάτο του γονιού, μαζί με τον πουρέ αρακά — το πιο εύκολο κομμάτι.', en: 'For brave tasters: the meat inside is mild and tender, but the skin and fat outside wobble like jelly. Try one bite from a parent’s plate, with the pea purée — the easy part.' },
    funFact: { el: 'Το όνομα σημαίνει «πόδι του πάγου»: λέγεται ότι πολύ παλιά οι άνθρωποι έφτιαχναν λεπίδες για παγοπέδιλα από τα μακριά κόκαλα του ποδιού των ζώων — και το όνομα έμεινε στο φαγητό.', en: 'The name means “ice leg”: the story goes that long ago people made ice-skate blades from the long leg bones of animals — and the name stuck to the dish.' },
  ...
  },
  {
    ...
    what: { el: 'Χυμός μήλου ανακατεμένος με ανθρακούχο νερό: ελαφρύς, δροσερός και λιγότερο γλυκός από τον σκέτο χυμό. Το ποτό που παραγγέλνουν τα περισσότερα παιδιά στη Γερμανία.', en: 'Apple juice mixed with sparkling water: light, cool and less sweet than plain juice. The drink most kids in Germany order.' },
    kidTip: { el: 'Πες «Eine Apfelschorle, bitte». Χωρίς φυσαλίδες; Ζήτα σκέτο χυμό (Apfelsaft). Θυμήσου: στα εστιατόρια της Γερμανίας το νερό έρχεται εμφιαλωμένο και συνήθως με φυσαλίδες — ζήτα «stilles Wasser» για χωρίς.', en: 'Say “Eine Apfelschorle, bitte”. No bubbles? Ask for plain juice (Apfelsaft). Remember: in German restaurants water comes bottled and usually fizzy — ask for “stilles Wasser” if you want still.' },
    funFact: { el: 'Οι Γερμανοί αγαπούν τις φυσαλίδες: η χώρα έχει πάνω από 500 διαφορετικά μεταλλικά νερά, γι’ αυτό εδώ ακόμη και ο χυμός σερβίρεται με φυσαλίδες.', en: 'Germans love bubbles: the country has more than 500 different mineral waters, which is why even juice is served fizzy here.' },
  ...
  },
  {
    ...
    what: { el: 'Η μπίρα του Βερολίνου: ελαφριά και ξινούτσικη, σε φαρδύ ποτήρι με μια δόση σιρόπι — κόκκινο από βατόμουρο ή πράσινο από ασπέρουλα. Μόνο για τους γονείς.', en: 'Berlin’s own beer: light and slightly sour, served in a wide glass with a shot of syrup — red from raspberry or green from woodruff. For the parents only.' },
    ...
    funFact: { el: 'Λέγεται ότι οι στρατιώτες του Ναπολέοντα, όταν μπήκαν στο Βερολίνο το 1806, τη βάφτισαν «σαμπάνια του Βορρά». Τον 19ο αιώνα την έφτιαχναν εκατοντάδες ζυθοποιεία της πόλης· σήμερα μόνο μια χούφτα.', en: 'The story goes that Napoleon’s soldiers, entering Berlin in 1806, nicknamed it the “Champagne of the North”. In the 19th century hundreds of the city’s breweries made it; today only a handful do.' },
