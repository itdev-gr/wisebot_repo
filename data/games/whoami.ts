...
export const WHOAMI_COPY: Record<'el' | 'en', WhoAmICopy> = {
  el: {
    ...
    shareTextFound: (q) => `Ποιος είμαι; στο WiseBot Academy: ο WiseBot βρήκε τον ήρωά μου με ${q} ερωτήσεις! Μπορείς να τον νικήσεις;`,
    shareTextStumped: 'Ποιος είμαι; στο WiseBot Academy: νίκησα τον WiseBot! Μπορείς κι εσύ;',
    shareTextReverse: (p, max) => `Ποιος είμαι; στο WiseBot Academy: έκανα ${p}/${max} πόντους! Εσύ;`,
    cardTitle: 'ΠΟΙΟΣ ΕΙΜΑΙ;',
    cardHeadlineFound: 'Ο WiseBot βρήκε τον ήρωά μου!',
    cardStatFound: (q) => `${q} ΕΡΩΤΗΣΕΙΣ`,
    cardHeadlineStumped: 'Νίκησα τον WiseBot!',
    cardStatStumped: '🏆',
  ...
  en: {
    ...
    shareTitle: 'Who Am I?',
    shareTextFound: (q) => `Who Am I? at WiseBot Academy: WiseBot found my hero in ${q} questions! Can you beat it?`,
